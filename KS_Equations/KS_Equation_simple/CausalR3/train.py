...
parser = argparse.ArgumentParser(description='Causal R3 Sampling for PINNs')
# parser.add_argument('--M_t', type=int, default=2, help='')
parser.add_argument('--M_x', type=int, default=5, help='')
parser.add_argument('--t0', type=float, default=0.0, help='')
parser.add_argument('--t1', type=float, default=1.0, help='')
parser.add_argument('--N', type=int, default=10, help='time marching windows')
parser.add_argument('--N_r', type=int, default=2048, help='Number of collocation points')
parser.add_argument('--window', type=int, default=0, help='Time Window')
...
parser.add_argument('--lambda_ic', type=float, default=1e3, help='')
parser.add_argument('--lambda_f', type=float, default=0.1, help='')
parser.add_argument('--layers', type=str, default="256, 256, 256, 1", help='Layer List')
...
parser.add_argument('--gate_type', type=str, default="tanh", help='Gate Function')
parser.add_argument('--beta_lr', type=float, default=0.005, help='Beta learning rate')
...
for k in range(args.N):
    ...
    model = PINN(key, arch, layers, args.M_x, state0, args.t0, t1_sub, dataset, x_star, args_dict)
