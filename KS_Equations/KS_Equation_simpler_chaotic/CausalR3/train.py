...
parser.add_argument('--N_r', type=int, default=4096, help='Number of collocation points')
...
parser.add_argument('--beta_lr', type=float, default=0.001, help='Beta learning rate')
