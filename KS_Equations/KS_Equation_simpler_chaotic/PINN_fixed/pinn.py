...
class PINN:
    ...
    def plot_results(self, u_pred, r_pred, usol, t_star, x_star, save_path, it):
        ...
        plt.title(r'Exact $u(x)$', fontsize=18)
        plt.tight_layout()
        ...
        plt.xlabel('$t$', fontsize=18)
        plt.ylabel('$x$', fontsize=18)
        plt.title(r'Predicted $u(x)$', fontsize=18)
        plt.tight_layout()
        ...
        plt.xlabel('$t$', fontsize=18)
        plt.ylabel('$x$', fontsize=18)
        plt.title('PDE Residuals', fontsize=18)
        plt.tight_layout()
    ...
    def train(self, nIter):
        ...
        for it in pbar:
            ...
            if it % 100 == 0:
                ...
                self.skew_log.append(skew_f)
                self.kurtosis_log.append(kurtosis_f)
