...
parser = argparse.ArgumentParser(description='PINN fixed')
...
for k in range(args.N):
    ...
    loss_dict = {
                   ...
                   "loss_ics_log":model.loss_ics_log,
                   "loss_res_log":model.loss_res_log,
                   "skew_log":model.skew_log,
                   "kurtosis_log":model.kurtosis_log,
                   "l2_error_log":model.l2_error_log,
                }
    ...
    torch.save(loss_dict, os.path.join(save_path, f'window_{k}_loss_dict.pth'))
